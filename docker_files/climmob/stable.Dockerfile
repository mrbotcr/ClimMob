FROM mrbotcr/climmob_base:20240105
...
RUN python3 -m venv climmob_env && git clone https://github.com/mrbotcr/ClimMob.git -b master climmob && . ./climmob_env/bin/activate && pip install wheel && pip install -r /opt/climmob/requirements.txt && python /opt/climmob/download_nltk_packages.py
